      ...
      <div style={{ margin: "auto" }} className="px-4 3xl:px-16">
        ...
        <section className="my-16">
          ...
          <div className=" h-[663px]">
            <img
              src={"/images/official/thumbnail/summer-2023.jpg"}
        ...
        <section className="pt-[70px] pb-[90px] my-4 bg-[#f8f0e9]">
          <ul className="w-full grid grid-cols-3 gap-4 my-6">
            <li className="place-content-center grid justify-items-center relative">
              ...
              <div className="absolute right-0 top-0 h-full w-px bg-gray-500" />
            </li>
            <li className=" relative place-content-center grid justify-items-center ">
              ...
              <p className="text-center text-textPrimary text-xs m-2">Đồng giá vận chuyển toàn quốc 30.000</p>
              <div className="absolute right-0 top-0 h-full w-px bg-gray-500" /> </li>
